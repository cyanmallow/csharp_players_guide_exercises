...
public class Tuple_Program
{
    ...
    //static void Main()
    //{
    //    Tuple_Program p = new Tuple_Program();
    //    p.Run();
    //}
    ...
    public void Run()
    {
        ...
        Console.WriteLine($"Heres your {meal.s} {meal.i} {meal.t}. Eat up and get fat so we can finally butcher you!!");
    }
}